...
def run_posmap_300W_LP(bfm, image_path, mat_path, save_folder, idx=0, uv_h=256, uv_w=256, image_h=256, image_w=256):
    ...
    image = io.imread(image_path) / 255. #(r , g ,b)
    [h, w, c] = image.shape
    ...
    #           (uv_position_map) / max(image_h, image_w, np.max(uv_position_map)))  # only for show
...
def generate_batch_sample(input_dir_list, save_folder='./300WLP'):
    ...
    for input_dir in input_dir_list:
        jpg_list = glob.glob(input_dir+'/*.jpg')
        for idx , img_path in enumerate(jpg_list):
            mat_path = img_path.replace('jpg','mat')
            run_posmap_300W_LP(bfm, img_path, mat_path, save_folder,num)
            num += 1
            print("Number {} uv_pos_map was generated!".format(num))
...
if __name__ == '__main__':
    ...
    # args.input_dir = ['../Data/PRNet_PyTorch_Data/300W_LP/AFW_Flip',
    #                 '../Data/PRNet_PyTorch_Data/300W_LP/HELEN_Flip',
    #                 # '../Data/PRNet_PyTorch_Data/300W_LP/IBUG',
    #                 '../Data/PRNet_PyTorch_Data/300W_LP/LFPW_Flip']

    # args.save_dir = '../Data/PRNet_PyTorch_Data/300WLP_AFW_HELEN_LFPW_Flip'

    args.input_dir = ['../Data/PRNet_PyTorch_Data/300W_LP/IBUG',
                     '../Data/PRNet_PyTorch_Data/300W_LP/IBUG_Flip',]

    args.save_dir = '../Data/PRNet_PyTorch_Data/300WLP_IBUG_Src_Flip'
